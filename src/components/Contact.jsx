      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-foreground mb-4">
            Contact <span className="text-primary">Seabuckthorn Soap Co.</span> - We're Here to Help
          </h2>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            <span className="font-semibold text-primary">Have questions about our organic seabuckthorn soaps, ingredients, or skin benefits?</span> Our customer support team responds within 24 hours. Reach out with product inquiries, bulk orders, or skincare advice.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <div className="bg-card rounded-2xl p-6 md:p-8 border border-border/30">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Tell us about your seabuckthorn soap questions, product recommendations needed, or bulk order inquiries. We'll respond promptly.
              </p>
              ...
              {isSubmitted ? (
                <div className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <h4 className="text-lg font-semibold text-foreground mb-1">Message Received!</h4>
                  <p className="text-sm text-muted-foreground">Thank you for contacting Seabuckthorn Soap Co. Our team will respond within 24 hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      placeholder="Example: Questions about seabuckthorn benefits for eczema, bulk orders, or product recommendations..."
                      required
                    />
                  </div>
                  ...
                  <p className="text-xs text-muted-foreground text-center">
                    We respect your privacy. 24-hour response time guaranteed.
                  </p>
                </form>
              )}
            </div>
          ...
          >
            ...
            <div className="bg-card rounded-2xl p-6 border border-border/30">
              ...
              <ul className="space-y-2.5 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span><span className="font-medium text-foreground">Product Questions:</span> Learn about seabuckthorn soap benefits for your skin type</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary font-bold mt-0.5">✓</span>
                  <span><span className="font-medium text-foreground">Skin Concerns:</span> Get personalized recommendations for eczema, sensitive skin, acne, or anti-aging</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary font-bold mt-0.5">✓</span>
                  <span><span className="font-medium text-foreground">Bulk Orders:</span> Wholesale inquiries for retailers and spas</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary font-bold mt-0.5">✓</span>
                  <span><span className="font-medium text-foreground">Shipping & Returns:</span> Fast responses on orders and delivery tracking</span>
                </li>
              </ul>
            </div>
            ...
            {/* Social Links -  */}
            <div className="bg-card rounded-2xl p-6 border border-border/30">
              <h4 className="font-semibold text-foreground mb-4">Follow Our Seabuckthorn Community</h4>
              <p className="text-sm text-muted-foreground mb-4">Connect with us on social media for skincare tips, product updates, and customer stories.</p>
              <div className="flex items-center gap-3">
                <a 
                  ...
                  aria-label="Follow Seabuckthorn Soap on Facebook"
                >
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-muted/50 hover:bg-primary rounded-xl flex items-center justify-center group transition-all duration-200"
                  aria-label="Follow Seabuckthorn Soap on Instagram"
                >
                  <svg className="w-5 h-5 fill-muted-foreground group-hover:fill-primary-foreground transition-colors" viewBox="0 0 24 24">
